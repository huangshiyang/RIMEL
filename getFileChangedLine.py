    ...
    for file in files_list:
        ...
        if i == 0 or i == 1:
            ...
            if modif:
                modif_res = True
            i+=1
            print("File " + str(file.filename) + " has additions = " + str(addition_res) + ", has deletions = " + str(deletion_res) + ", both = " + str(addition_and_deletion_res) + ", has added imports = " + str(import_added_res) + " and has modifieded functions  = " + str(modif_res) )
